...
function layer:createClones()
    ...
    for t=1,self.seq_length do
        self.cores[t] = self.core:clone('weight', 'bias', 'gradWeight', 'gradBias', 'weightMask')
    end
    --self:shareClones()
end
...
function layer:shareClones()
    ...
    for t=1,self.seq_length do
        self.cores[t]:share(self.core, 'weight', 'bias', 'gradWeight', 'gradBias', 'weightMask')
    end
end
...
function layer:parameters()
    ...
    local p1,g1 = self.cores[t]:parameters()
